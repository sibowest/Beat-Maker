!function() {
    ...
    class r extends React.Component {
        ...
        activatePad() {
            this.props.power ? "#01BAEF" === this.state.padStyle.backgroundColor ? this.setState({
                padStyle: s
            }) : this.setState({
                padStyle: a
    ...
    class o extends React.Component {
        ...
        render() {
            ...
            }, "Drum Machine"+ String.fromCharCode(160)), React.createElement("img", {
                src: "/logo1.png",className: "inner-logo", style:{width: 25, top: 30},
            })), React.createElement("div", {
    ...
    ReactDOM.render(React.createElement(o, null), document.getElementById("main"))
}();
